...
const MoPlusKen = () => {
    ...
    return (
        <div className={'mo-ken-container'}>
            <HeaderTitleWithImg title={'LET’S COLLABORATE'}
            ...
            <section className={'mo-ken-overview'}>
                ...
                <div className={'mo-ken-overview-main'}>
                    ...
                    <Text className={'mo-ken-overview-description'}
                        ...
                        brand experiences, a startup is able to effectively convert potential users into brand ambassadors
                        and differentiate themselves at an early stage from competitors. At Kenergy, we work directly with
            ...
            <TwoColumnsHugeInfo title={'HOW WE CAN COLLABORATE'}
                            ...
                            rightTitle={'Our role consists of taking the time to understand your business model, ' +
            ...
            <TitleTwoDescriptions
                ...
                title={'A global startup program that fosters and invests in bright and passionate early stage founders with cutting-edge ideas.'}
            ...
            <div>
                {
                    options.something.map((data, index) => {
                        return (
                          <Something {...data} key={'something' + index}/>
                        )
                    })
                }
            </div>
