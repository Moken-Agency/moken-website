...
export default [
    ...
    },
    {
        description: [
            {
                title:
                    "We are in search of a part-time, contract based Graphic Designer with strong visual design skills to support our motivated internal team. ​The ideal candidate will be responsible for a wide range of digital design work that includes logos and branding concepts, digital content, print materials, trade show displays, and any other design collateral as needed.",
            },
            {
