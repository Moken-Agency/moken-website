...
export default [
...

    {
        description: [
            {
                title: 'You have excellent communication skills, with an openness to accepting alternativeopinions and methods from other team members' +
                    '\n' +
...

    {
        description: [
            {
                title: 'We encourage all those who believe they have what it takes to be successful and are up forthe challenge to apply.'
            },
            {
                title: 'ONLY APPLICATIONS SUBMITTED THROUGH THE FOLLOWING METHOD WILL BEREVIEWED AND CONSIDERED'
            },
            {
                title: 'To submit an application, please email careers@mokenstartups.com with the subjectline​ “Potato 凜 ”​ with your resume, an introductory 30-second video, links for yourGithub sample projects, and any other links for any projects that you contributedheavily in.'
            }
        ]
    }
