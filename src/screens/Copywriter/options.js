...
export default [
...

    {
        description: [
            {
                title: 'We\'re looking for a creative copywriter to create exceptional content for all facets of Moken,clients, and portfolio startups. You’ll have the opportunity to work on projects ranging fromsocial media captions, paid advertising campaigns, ebooks, team guides,  event descriptionsand even case studies'
            },
            {
                title: 'The ideal candidate will be comfortable working with a wide variety of internal and externalteams helping to build Moken and its clients brands. You’ll aim to educate and connect ourglobal community through your content and develop the relevant written creative assets todo so. Additionally, you’ll have the opportunity to contribute to a wide range of industryprojects as a member of our client facing project team.'
            }
        ]
    },
    ...
    {
        description: [{
            title: 'You’ll craft short-form content designed to capture the hearts of our community whileimproving the clarity of our offerings while inspiring action' +
                '\n' +
...

    {
        description: [
            {
                title: 'You have at least 4+ years of agency, in-house, or other relevant copywriting experience' +
                    '\n' +
...

    {
        description: [
            {
                title: 'For this position, although experience is key, it does not necessarily need to be in this exactrole previously. Therefore, we encourage all those who believe they have what it takes to besuccessful and are up for the challenge to apply.'
            },

            {
                title: 'ONLY APPLICATIONS SUBMITTED THROUGH THE FOLLOWING METHOD WILL BEREVIEWED AND CONSIDERED'
            },

            {
                title: 'To submit an application, please email careers@mokengroup.com with the subjectline “​Fishy fish​” with your resume, an introductory 30-second video, a coverletter, and a sample of your past writing or portfolio of work.'
            },

            {
                title: 'In addition, students who are currently enrolled in a communications or marketingpost-secondary program who are interested in hands-on, compensated experience weencourage you to apply as we do have junior-level opportunities available.'
            }
        ]
    }
