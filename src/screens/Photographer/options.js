...
export default [
...

    {
        description: [
            {
                title: 'You’ll photograph all web products for usage on both our web sites and socialchannels as needed.' +
                    '\n' +
...

    {
        description: [
            {
                title: 'You’ll have a working knowledge/experience of Adobe Photoshop, In-Design,Lightroom and or other photo editing software.' +
                    '\n' +
                    'You’ll be ready to try something new every time you step behind the camera' +
                    '\n' +
                    'You’re ready to create something incredible and push the boundaries of theimagination' +
...

    {
        description: [
            {
                title: 'n this role, you will gain the opportunity to establish long term relationships withgrowing companies globally while shaping the future of Moken and startupsthroughout Canada'
            }
        ]
    },
...

    {
        description: [
            ...
            {
                title: 'To submit an application, please email careers@mokenstartups.com with the subjectline “​Rawr!ADinosaur​” with your resume, an introductory 30-second video, acover letter, and your portfolio of past work.'
            },
            {
                title: 'In addition, students who are currently enrolled in a film, production, or photography focusedpost-secondary program who are interested in hands-on, compensated experience weencourage you to apply as we do have junior-level opportunities available.'
            }
        ]
    }
