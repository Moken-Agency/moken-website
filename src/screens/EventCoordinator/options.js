export default [
    ...
    {
        subtitle: 'We elevate your brand’s presence with custom strategy, channel expertise & flawless execution.'
    },
    {
        description: [
            {
                title: 'Consumers move seamlessly between platforms and media. So, multi-disciplinary doesn’t even begin to cover it — The most effective branding and marketing achieves balance, a mix of strategy, analytics, and magic. Your brand is the most valuable business asset you own.\n' +
    ...
    },
    {
        description: [
            {
                title: '\'You’ll harness your skills to mix social management with content creation to scale a variety of Instagram accounts.\\n\' +\n' +
