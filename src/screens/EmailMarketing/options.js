...
export default [
    ...
    {
        description: [
            {title: 'We are seeking a success-driven, email-crazed leader to join our community obsessedmarketing team aimed at connecting our digital touchpoints. The ideal candidate\'s goal is tocreate email campaigns aimed at conversion with a more personal, relevant, and impactfullydriven approach for both Moken and our startup clients. A successful candidate will developand execute email marketing strategies that build brand awareness, increase purchaseintent, create community, and drive retention.'
        }]
    },
...

    {
        description: [
            {
                title: 'You’ll be responsible for executing on all nurturing and engagement programs,managing email compliance, and developing on email campaigns to support ourmarketing efforts globally' +
                    '\n' +
...

    {
        description: [
            {
                title: 'For this position, although experience is key, it does not necessarily need to be in this exactrole previously and a marketing role with emphasis on email marketing is satisfactory.Therefore, we encourage all those who believe they have what it takes to be successful andare up for the challenge to apply.'
            },
            {
                title: 'ONLY APPLICATIONS SUBMITTED THROUGH THE FOLLOWING METHOD WILL BEREVIEWED AND CONSIDERED'
            },
            {
                title: 'To submit an application, please email careers@mokenstartups.com with the subjectline “​Oink!Oink!” with your resume, an introductory 30-second video, a coverletter, and a few examples of your past email marketing work.'
            },
        ]
    }
    // {
