            ...
            <div style={{display: 'flex', paddingLeft: isMobile? 0 : 50, alignItems: 'center', flexDirection: isMobile ? 'column' : 'row'}}>
                <div style={{marginRight: isMobile ? 0 : 100, marginBottom: isMobile ? 40 : 0}}>
                    <Text size={55}
                          ...
                          mobSize={35} type={'extraLight'} containerStyles={{marginBottom: 63}}>{title}</Text>
                    <Text size={20}
                          animationType={'fade-up'}
                    ...
                    <div style={{position: 'relative', display: 'flex'}}>
                        ...
                        <div>
                            ...
                            <Text type={'semiBold'}
                                  animationType={'fade-up'}
                                  containerStyles={{marginBottom: 30}} size={24}>{startUpName}</Text>
                            <Text type={'semiBold'}
                                  animationType={'fade-up'}
                                  containerStyles={{marginBottom: 15}} size={16} mobSize={10}>{founderName}</Text>
                            <Text type={'semiBold'}
                                  animationType={'fade-up'}
                                  size={16} mobSize={10}>{founderTitle}</Text>
                        </div>
                    </div>
                </div>
