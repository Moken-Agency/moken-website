  ...
  return (
    <div className={"for-students-container"}>
      <HeaderTitle
        ...
        description={`The future generation is the core of our community. We work together to create a future that is better than the last.`}
...
in pursuit of success.`
      ...
      <LeftInfoWithRightImage
        withoutRightPadding
        title={
          "Education is the core of growth where knowledge drives innovation forwards."
        }
