...
import useWindowDimensionsSecond from "../../hooks/useWindowDimensions";
...
const limitWidth = 1100;

const SmallWidthStartups = ({ width }) => {
  if (width < limitWidth) {
    return (
...
const Home = () => {
  ...
  const { isMobile } = useWindowDimensionsSecond();
  ...
  return (
    ...
    <div className={"home-container"}>
      <section className={"home-header"}>
        <div className={"home-header-first-title-container"}>
          <Text
            ...
            size={20}
            mobSize={12}
            className={"home-header-first-title-tm"}
          >
            TM
          </Text>
          <Text
            ...
            size={120}
            mobSize={30}
            className={"home-header-first-title"}
          >
            We are moken.
          </Text>
        ...
        <Text className={"home-header-second-title"} type={"kLight"} size={20}>
          Moken is a hub for founders and startups guiding them through the
          journey of building a successful venture from ideation to growth.
        </Text>
      </section>

      <section className={"home-explore-container"}>
        <div
          className={"home-explore-divider-container"}
        ...
        >
          ...
          <Text className={"home-explore-title"} type={"kMedium"} size={16}>
            EXPLORE
          </Text>
        </div>
        ...
        <div className={"home-explore-list-container"}>
          {explores.map((explore, index) => (
            <HomeExplore {...explore} key={index + "home-explores"} />
          ))}
        </div>
      </section>
      ...
      <Swiper
        swiperData={explores}
        breakpoints={{ "0": { slidesPerView: 1.25 } }}
        containerClassName={"home-explore-list-container-mob"}
      ...
      <section className={"home-ecosystem-container"} data-aos="fade-in">
        <HomeDescriptionDataComponent
          descriptionData={{
            ...
            description:
              "A community comprised of passionate entrepreneurs, innovators, investors, and builders who share a goal of making an impact.",
            btnOptions: {
                  ...
                  {(value) => {
                    return (
                      ...
                      >
                        ...
                        >
                          <Text type={"kMedium"} size={24} mobSize={16}>
                            a community of
                          </Text>
                          <Text
                            withCountAnimation
                            countAnimationProps={{ duration: 1.4 }}
                            type={"kBold"}
                            mobSize={75}
                            size={100}
                          >
          ...
          return (
            <div className={"home-startups-list-container"}>
              {startupsData.map(({ title, subtitle, suffix = "" }, index) => {
                return (
                  <div
                    className={"startups-item"}
                    key={"startupsData" + title + index}
                  >
                    <TrackVisibility once>
                      {({ isVisible }) =>
                        isVisible && (
                          <>
                            ...
                            <Text
                              size={16}
                              className={"startups-item-subtitle"}
                              type={"kRegular"}
                            >
                              {subtitle}
                            </Text>
      ...
      <HomeComponentWithVerticalText
        ...
        descriptionData={{
          ...
          description:
            "Developing meaningful brand experiences and unforgettable events that expand beyond traditional tactics and focus on audience engagement and strategy.",
          btnOptions: {
      ...
      <section className={"home-book-container"}>
        <Text type={"kBold"} size={45} className={"home-book-title"}>
          Book a free call with us now and we’ll help you map out your strategy.
        </Text>
        <Text type={"kLight"} size={20} className={"home-book-description"}>
          We would love to connect with you, learn more about your startup,
          identify struggles and opportunities together, and give our
          perspective on what you should be focusing on in the immediate to
          drive your business forward.
        </Text>
        <Button
          title={"BOOK YOUR CALL"}
          onClick={() =>
            window.open("https://meetings.hubspot.com/mohamed24", "_blank")
          }
        />
      </section>
    </div>
