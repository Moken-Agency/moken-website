...
export default [
    ...
    },
    {
        description: [
            {
                title: 'We’re looking for an enthusiastic Social Media Specialist that will be responsible for' +
...

    {
        description: [
            {
                title: 'You’re a lover of all things social media. From IGTV to Twitter to LinkedIn andYouTube, if it’s social media, it\'s your thing' +
                    '\n' +
...

    {
        description: [
            {
                title: 'In this role, you will gain the opportunity to establish long term relationships whilepotentially shaping the future of Moken and startups throughout Canada.' +
                    '\n' +
    ...
    {
        description: [
            {title: 'For this position, although experience is key, it does not necessarily need to be in this exactrole' +
                    ' previously. Therefore, we encourage all those who believe they have what it takes to besuccessful and are' +
                    ' up for the challenge to apply.'},
            {
