...
export default [
    ...
    },
    {
        description: [
            {
                title: 'We are in search of a part-time, contract based Graphic Designer with strong visual designskills to support our motivated internal team. ​The ideal candidate will be responsible for awide range of digital design work that includes logos and branding concepts, digital content,print materials, trade show displays, and any other design collateral as needed.'
            },
            {
                title: 'Like most professionals in this role, the selected candidate should have a full imagination ofvisual wizardry and thrive in experimenting with creative solutions. The ideal candidateshould be comfortable or have experience designing for technology or startup brands.'
            }
        ]
    },
    {
    ...
    },
    {
        description: [
            {
                title: 'You’ll design branded, graphic and technical assets such as bespoke iconographyand visually meaningful illustrations using a range of 2D and 3D techniques'+
                    '\n' +
    ...
    },
    {
        description: [
            ...
            {
                title: 'To submit an application, please email careers@mokenstartups.com with the subjectline “​Boo!​” with your resume, an introductory 30-second video, a cover letter, andyour portfolio.'
            },
            {
                title: 'In addition, students who are currently enrolled in a design or graphic arts post-secondaryprogram who are interested in hands-on, compensated experience we encourage you toapply as we do have junior-level opportunities available.'
