    ...
    return (
        <div className={'start-up-smart-container'}>
            <div className={'start-up-smart-first'}>
                ...
                <Text className={'start-up-smart-first-text-second'} mobSize={45} type={'thin'} size={'3.5vw'}>
            ...
            <div className={'start-up-smart-third'}>
                ...
                <Text mobSize={12} clPassName={'start-up-smart-third-text-third'} type={'semiBold'} size={'1vw'}>GET IN TOUCH</Text>
            </div>
            ...
            <div className={'start-up-smart-fifth'}>
                ...
                <Text mobSize={35} className={'start-up-smart-fifth-text-second'} type={'extraLight'} size={'3vw'}>We make it easy to kickstart your vision.</Text>
                <Text mobSize={16} type={'light'} size={'1.5vw'}>With packages at a startup price point, we work with founders and ideators with high growth potential. We're passionate about big ideas and working with people who feel the same.</Text>
            </div>
