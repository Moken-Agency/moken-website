...
export default [
...

    {
        description: [
            {
                title: 'We\'re looking for an innovative videographer eager to create the unthinkable while getting inon the ground floor of a rapidly growing company and community. This is a chance to join astartup community with traction while learning all the ins and outs of new media.'
            },
            {
                title: 'We are seeking a Videographer to work independently and with our team through producingand editing videos for both Moken and our client’s promotional use. You will have theopportunity to work professionally with startup founders, business leaders, and industryinfluencers by attending all events, leading photoshoots, as well as scheduling photographicand related services as required.'
            }
        ]
    },
...

    {
        description: [
            {
                title: 'You’ll work with our creative and marketing teams to understand project scope andobjectives' +
                    '\n' +
...

    {
        description: [
            ...
            {
                title: 'To submit an application, please email careers@mokenstartups.com with the subjectline “​Rain,Rain,GoAway!⛈​” with your resume, an introductory 30-second video,a cover letter, and your portfolio of past work.'
            },
            {
                title: 'In addition, students who are currently enrolled in a film or production focusedpost-secondary program who are interested in hands-on, compensated experience weencourage you to apply as we do have junior-level opportunities available.'
            }
        ]
    }
