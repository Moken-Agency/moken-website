export default [
  ...
  },
  {
    description: [
      {
        title:
          "Moken Startups Inc., an Incorporated Canadian company, (hereinafter “Moken” or “We/Us/Our”) provides services, products and information via our website (located at https://mokenstartups.com, https://academy.mokenstartups.com, https://shop.mokenstartups.com, and https://access.mokenstartups.com), our Facebook Pages (located at https://facebook.com/mokenstartups, https://facebook.com/mokenagency), Medium (located at https://medium.com/insightsbymoken), Instagram (located at https://instagram.com/mokenstartups, https://instagram.com/mokenagency), YouTube (located at https://youtube.com/moken) and other platforms which may be added or removed at any time.  Collectively, these sites are referred to as the “Platform(s)” and include all versions accessible through all devices (such as mobile and desktop apps, web browsers, etc.)",
      },
    ],
  },
  {
  ...
  },
  {
    description: [
      {
        title:
          "We provide products in the form of physical goods and downloadable digital products.  We also provide access and subscriptions to courses and course materials.  Collectively, we refer to our products, services, courses, and subscriptions as “Our Products.”  All purchasers of any of Our Products agree to the following conditions for any paid transaction with us (hereinafter, “Payment Terms”). You warrant and represent that you are authorized to use any payment method you provide to us (such as PayPal accounts or credit cards).  You agree to indemnify us against losses we may sustain as a result of any breach of this warranty. We use third-party vendors to process payments for Our Products.",
      },
      {
        title:
          "These vendors are currently PayPal and Stripe.  Visit https://PayPal.com and https://Stripe.com to view these vendors’ specific privacy policies and terms and conditions.  Our Privacy Policy applies only to data over which We have control. Our Products that are sold and distributed in a digital format are non-refundable, including any subscriptions for a series of courses, online courses, digital ebooks, or memberships in any digital networks or other online communities. ",
      },
      {
        title:
          "Our Products that are physical goods (“Physical Products”) are refundable if returned to Us in unused condition within 10-days following delivery to You. Physical Products must be in the same condition in which You received them and must be returned in the same packaging with any labels remaining (not removed).  You are responsible for the costs of any shipping for any returns.  Within 10 days following receipt of any returned Physical Product, we will issue a refund of the purchase price of the Physical Product via the same payment method that was used to purchase the Physical Product.  All shipping costs are not refundable and remain Your responsibility.We reserve the right to change the costs of our Products at any time.  Please check with our Platforms for the latest pricing.",
      },
    ],
  },
  {
    title: "CONDUCT OF USERS",
  },
  {
    description: [
      {
        title:
          "Users of Our Platforms understand and agree that Our Platforms may only be used for lawful purposes and in accordance with these Terms & Conditions. Users of Our Platforms represent that You are of legal age and capable of forming a binding contract with Us. These Terms & Conditions are a binding contract.",
      },
      {
        title:
      ...
      {
        title:
          "— You will not violate or encourage the violation of any local, provincial, national, or international law or regulation.",
        containerStyles: {
          marginBottom: 0,
        },
      },
  ...
  },
  {
    description: [
      ...
      {
        title:
          "Allegations of Infringement.  If You believe that any of Our Materials violates Your copyright(s) or other rights, You may request removal of those materials from Our Platforms by submitting written notice. Your notice must include the following:",
      },
      {
        title: "— Your name, address and contact information.",
        containerStyles: {
          marginBottom: 0,
        },
      },
      ...
      {
        title: "Send your Intellectual Copyright Infringement Notice to:",
        containerStyles: {
          marginBottom: 0,
        },
      },
      ...
      {
        title: "Moken Startups Inc.",
        containerStyles: {
          marginBottom: 0,
        },
      },
      {
        title: "128 W Pender St Suite 1400",
        containerStyles: {
          marginBottom: 0,
        },
      },
      {
        title: "Vancouver, BC V6B 1R8",
      },
    ],
  },
  {
  ...
  },
  {
    description: [
      ...
      {
        title:
          "Any Disputes shall be resolved by binding arbitration before a single arbitrator in accordance with the then-existing rules of the Province of British Columbia and Federally within Canada.  In the event that such arbitration service is no longer operating, then the Arbitration service generally accepted by law within British Columbia shall substitute.  Venue for any such dispute shall be the Province of British Columbia and Canada laws shall apply. You further agree that this dispute resolution mechanism shall be Your sole means to seek a remedy for any Dispute and that You will not engage in any class action or other collective action regarding any Dispute You may have with us.  You understand that by voluntarily providing information to Us, by using Our Website or by otherwise engaging in any transaction with Us involving Our products or services, that You are waiving any rights to a trial by jury or to join any collective or class action litigation involving any Dispute.",
      },
    ],
  },
  {
