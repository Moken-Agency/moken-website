...
const Swiper = ({children, className = ''}) => {
    ...
    return (
        <div id={'swiper'} className={`swiper-container ${className}`} onScroll={onScroll}>
            {children}
            <div className={'swiper-button-container'} style={buttonContainerDynamicStyles}>
                <div className={'swiper-button'} style={buttonDynamicStyles} onClick={scrollToEnd}>
