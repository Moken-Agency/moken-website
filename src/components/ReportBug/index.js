...
const ReportBug = (props) => {
    ...
    return (
        <Modal buttonTitle={'report a bug'.toUpperCase()} buttonClassName={'report-a-bug-button'}>
            <div className={'report-bug-container'}>
                <div className={'report-bug-left-container'}>
                    <Text size={'.8vw'}
                          mobSize={16}
                          type={'semiBold'}
                          textStyles={{letterSpacing: 4}}>FOUND A TYPO?</Text>
                    <Text size={'.8vw'}
                          mobSize={16}
                          type={'semiBold'}
                          textStyles={{letterSpacing: 4}}
                          containerStyles={{marginBottom: isMobile ? 20 : 0}}>SOMETHING JUST NOT WORKING RIGHT?</Text>
                    <Text size={'4.3vw'}
                          mobSize={45}
                          type={'thin'}
                          containerStyles={{marginBottom: isMobile ? 55 : '5.4vw'}}>Report a Bug</Text>
                    <Input size={'.9vw'}
                           mobSize={14}
                           type={'light'}
                           ...
                           <div className={'screenshot-container'}>
                               ...
                               <div className={'screenshot-text-container'}>
                                   <Text type={'semiBold'}
                                         size={'.56vw'}
                                         mobSize={10}
                                         containerStyles={{marginBottom: 5}}>Attach a screenshot of the issue (*If applicable)</Text>
                                   <Text type={'light'} size={'.45vw'} mobSize={8}>Max file size is 10MB</Text>
                               </div>
                           </div>
